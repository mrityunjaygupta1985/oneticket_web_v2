        ...
        <>
            <div className={`fixed bottom-6 right-6 z-[60] flex flex-col items-end gap-4`}>
                ...
                <button 
                    ...
                    className="w-14 h-14 rounded-full bg-blue-600 text-white shadow-xl hover:bg-blue-700 transition-all hover:scale-105 flex items-center justify-center text-xl relative"
                >
                    <i className={`fa-solid ${isOpen ? 'fa-chevron-down' : 'fa-message'} transition-transform duration-300`}></i>
                    {!isOpen && (
